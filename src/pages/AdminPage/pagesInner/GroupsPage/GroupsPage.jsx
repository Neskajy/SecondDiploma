...
import AddGroupModal from "./modals/AddGroupModal/AddGroupModal.jsx";

import { Link, useLocation } from "react-router-dom";

import { AddGroupModalContext } from "../../../../Contexts.jsx";
...
export default function GroupsPage() {
    ...
    return (
        <AddGroupModalContext.Provider value={{isAddGroupModalActive, setIsAddGroupModalActive}}>
            <div className={s.GroupsPage} style={{display: "flex"}}>
                ...
                <div className={s.HeaderAndContent} style={{width: "100%"}}>
                    ...
                    <main className={s.main}>
                        <div className={s.container}>
                            <h5>Группы</h5>
                            <button className={s.add__group} onClick={OpenGroupModal}>
                                Добавить группу
                            </button>
                ...
                {isAddGroupModalActive ? <AddGroupModal /> : ""}
            </div>
